...
namespace FitForge.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910142901_AddSessionAndSignInAttempt")]
    partial class AddSessionAndSignInAttempt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitForge.Domain.Members.Session", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MemberId")
                        .HasDatabaseName("IX_Session_MemberId");
            ...
            modelBuilder.Entity("FitForge.Domain.Members.SignInAttempt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("NormalizedEmail", "AttemptedAtUtc")
                        .HasDatabaseName("IX_SignInAttempt_Email_At");

                    b.HasIndex("SourceHash", "AttemptedAtUtc")
                        .HasDatabaseName("IX_SignInAttempt_Source_At");

                    b.ToTable("SignInAttempt", (string)null);
                });
            ...
            modelBuilder.Entity("FitForge.Domain.Members.Session", b =>
                {
                    b.HasOne("FitForge.Domain.Members.Member", null)
                        .WithMany()
